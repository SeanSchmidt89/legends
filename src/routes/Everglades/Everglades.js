...
const Everglades = () => {
  ...
  let infoArr = ["Everglades National Park", "a 1.5-million-acre wetlands preserve on the southern tip of the U.S. state of Florida"];
  let props = {
    imgArr,
    infoArr,
  };
  return <div><Slider data={props}/></div>;
};
