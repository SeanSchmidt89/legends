...
const LittleHavana = () => {
  let imgArr = [
    ...
    "https://images.unsplash.com/photo-1603737228554-1b1a137a096a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80",
  ];
